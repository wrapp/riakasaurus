...
_RPBSEARCHDOC = descriptor.Descriptor(
  name='RpbSearchDoc',
...
_RPBSEARCHQUERYREQ = descriptor.Descriptor(
...
_RPBSEARCHQUERYRESP = descriptor.Descriptor(
